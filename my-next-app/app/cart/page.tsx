                                        ...
                                        <div className="mt-4 space-y-3 animate-in fade-in slide-in-from-top-2 duration-300">
                                            ...
                                            >
                                                ...
                                                <div className="text-right">
                                                    ...
                                                    <p className="font-bold text-[#333333] text-sm md:text-base">₹250</p>
                                                </div>
                                            </div>
                                            ...
                                            >
                                                ...
                                                <div className="text-right">
                                                    <p className="text-[9px] md:text-[10px] text-gray-400 font-medium uppercase">Fee</p>
                                                    <p className="font-bold text-[#333333] text-sm md:text-base">₹150</p>
                                                </div>
                                            </div>
                                        ...
                                        <div className="bg-[#FBFAFA] rounded-3xl p-4 space-y-4 animate-in fade-in slide-in-from-top-2 duration-300">
                                            ...
                                            <div className="bg-white rounded-2xl border border-gray-100 flex overflow-hidden opacity-60 grayscale shadow-sm hover:shadow-md transition-shadow">
                                                <div className="flex-1 p-4 space-y-1">
                                                    ...
                                                    <p className="text-[10px] text-gray-500 font-medium">Minimum order <span className="text-red-500">₹2,999</span></p>
                                                    <p className="text-[9px] text-gray-400 italic">Best value deal</p>
                                                </div>
                                                <div className="relative w-24 bg-gray-200 flex items-center justify-center text-gray-500 border-l border-dashed border-gray-300">
                                                    {/* Notched cutouts */}
                                                    <div className="absolute -left-2 top-1/2 -translate-y-1/2 w-4 h-4 bg-[#FBFAFA] rounded-full" />
                ...
                <div className="px-4 py-6">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="text-right">
                                <button className="text-[11px] font-bold text-[#333333] underline">View Coupons</button>
                            </div>
                        </div>
