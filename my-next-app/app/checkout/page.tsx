...
const CheckoutPage = () => {
    ...
    const subtotal = cartItems?.reduce((acc, item: any) => acc + (Number(item.finalPrice) * Number(item.quantity) || 0), 0) || 0;
    const itemsMRP = cartItems?.reduce((acc, item: any) => acc + (Number(item.mrp) * Number(item.quantity) || 0), 0) || 0;
    const totalSaving = itemsMRP - subtotal;
    const totalQuantity = cartItems?.reduce((acc, item: any) => acc + (Number(item.quantity) || 0), 0) || 0;
                                ...
                                {currentStep === 0 ? (
                                    ...
                                    <div className="w-full max-w-[40rem] lg:ml-6 space-y-4 md:space-y-5 pb-10">
                                        ...
                                        <div className="relative">
                                            <fieldset className="border-2 border-[#EE9C24] rounded-xl px-4 py-1">
                                                ...
                                                <div className="flex items-center justify-between py-2">
                                                    <input type="text" placeholder="Enter Your Number" className="bg-transparent border-none outline-none text-[#999999] font-medium w-full text-[1rem]" />
                                                    <Pencil className="text-gray-400" size={18} />
                                                </div>
                                            </fieldset>
                                        </div>
                                        ...
                                        <div className="relative">
                                            <fieldset className="border-2 border-[#EE9C24] rounded-xl px-4 py-1">
                                                ...
                                                <div className="flex items-center justify-between py-2">
                                                    <input type="text" placeholder="Enter Your Company name" className="bg-transparent border-none outline-none text-[#333333] font-medium w-full text-[1rem]" />
                                                    <Pencil className="text-gray-400" size={18} />
                                                </div>
                                            </fieldset>
                                        </div>
                                            ...
                                            <div className="flex-1 relative">
                                                <fieldset className="border-2 border-[#EE9C24] rounded-xl px-4 py-1">
                                                    ...
                                                    <div className="flex items-center py-2">
                                                        <input type="text" placeholder="Enter Your Number" className="bg-transparent border-none outline-none text-[#333333] font-medium w-full text-sm md:text-[1rem]" />
                                                    </div>
                                                </fieldset>
                                            </div>
                                            <div className="flex-1 relative">
                                        ...
                                        <div className="relative">
                                            <fieldset className="border-2 border-[#EE9C24] rounded-xl px-4 py-1">
                                                ...
                                                <div className="flex items-center justify-between py-2">
                                                    <input type="text" placeholder="Enter Your Number" value={contactData.phone} onChange={(e) => setContactData({ ...contactData, phone: e.target.value })} className="bg-transparent border-none outline-none text-[#333333] font-medium w-full md:text-[1rem]" />
                                                    <Pencil className="text-gray-400" size={18} />
                                                </div>
                                            </fieldset>
                                        </div>
                                        ...
                                        <div className="relative">
                                            <fieldset className="border-2 border-[#EE9C24] rounded-xl px-4 py-1">
                                                ...
                                                <div className="flex items-center justify-between py-2">
                                                    <input type="text" placeholder="Enter Your Number" value={contactData.email} onChange={(e) => setContactData({ ...contactData, email: e.target.value })} className="bg-transparent border-none outline-none text-[#333333] font-medium w-full md:text-[1rem]" />
                                                    <Pencil className="text-gray-400" size={18} />
                                                </div>
                                            </fieldset>
                                        </div>
                                        ...
                                        <div className="relative">
                                            <fieldset className="border-2 border-[#EE9C24] rounded-xl px-4 py-1">
                                                ...
                                                <div className="flex items-center justify-between py-2">
                                                    <input type="text" placeholder="Enter Your Number" value={contactData.street} onChange={(e) => setContactData({ ...contactData, street: e.target.value })} className="bg-transparent border-none outline-none text-[#333333] font-medium w-full md:text-[1rem]" />
                                                    <Pencil className="text-gray-400" size={18} />
                                                </div>
                                            </fieldset>
                                        </div>
                                        ...
                                        <div className="relative">
                                            <fieldset className="border-2 border-[#EE9C24] rounded-xl px-4 py-1">
                                                ...
                                                <div className="flex items-center justify-between py-2">
                                                    <input type="text" placeholder="Enter Your Number" className="bg-transparent border-none outline-none text-[#333333] font-medium w-full md:text-[1rem]" />
                                        ...
                                        <div className="space-y-4 pt-4">
                                            ...
                                            >
                                                ...
                                                <div className="text-right">
                                                    ...
                                                    <p className="text-[#0D0C0D]  text-md">₹250</p>
                                                </div>
                                            </div>
                                    ...
                                    <div className=" lg:ml-6 space-y-6">
                                        ...
                                        <div className="flex gap-4 ">
                                            ...
                                            <button
                                                onClick={handleContinue}
                                                className="flex-1 py-2 bg-gradient-to-r from-[#EE9C24] to-[#B3520A] text-white rounded-full font-bold text-lg shadow-lg hover:shadow-xl transition-all active:scale-[0.98]"
                                            >
                                                Place order
                                            </button>
                                        </div>
                            ...
                            {!isSuccess ? (
                                ...
                                <>
                                    ...
                                    <div className="space-y-4 mb-8">
                                        <div className="flex justify-between items-center">
                                            <span className="text-gray-500 font-bold text-[14px]">Items total (MRP)</span>
                                            <span className="text-gray-900 font-bold text-sm">₹{itemsMRP.toFixed(2)}</span>
                                        </div>
                                        <div className="flex justify-between items-center">
                                            <span className="text-gray-500 font-bold text-[14px]">Items Quantity</span>
                                            <span className="text-gray-900 font-bold text-sm">{totalQuantity} items</span>
                                        </div>
                                        <div className="flex justify-between items-center text-[#198E44]">
                                            <span className="font-bold text-[14px]">Total Savings</span>
                                            <span className="font-bold text-sm">-₹{totalSaving.toFixed(2)}</span>
                                        </div>
                                        <div className="pt-2 border-t border-gray-100 flex justify-between items-center">
                                            <span className="text-gray-500 font-bold text-[14px]">Net Subtotal</span>
                                            <span className="text-gray-900 font-bold text-sm">₹{subtotal.toFixed(2)}</span>
                                        </div>

                                        <div className="pt-4 space-y-3">
                                            <h3 className="text-gray-900 font-bold text-[14px]">Shipping Details</h3>
                                            <div className="flex justify-between items-center">
                                                <span className="text-gray-400 font-bold text-xs uppercase tracking-tight">Total Weight</span>
                                                <span className="text-gray-900 font-bold text-sm">{(cartItems?.reduce((acc, item: any) => acc + (Number(item.variantId?.weight?.value || 0) * Number(item.quantity || 0)), 0) || 0) / 1000} kg</span>
                                            </div>
                                            <div className="flex justify-between items-center text-[#EE9C24]">
                                                <span className="font-bold text-xs uppercase tracking-tight">Delivery Fee</span>
                                                <span className="font-bold text-sm">+₹{shippingFee.toFixed(2)}</span>
                                            </div>
                                        </div>
                                    </div>

                                    {/* Grand Total */}
                                    <div className="pt-6 border-t border-gray-100 flex justify-between items-end mb-10">
                                        <div>
                                            <h3 className="text-xl font-extrabold text-gray-900 leading-tight">Grand Total</h3>
                                            <p className="text-[10px] text-gray-400 font-bold uppercase tracking-tighter">Amount Paid Online</p>
                                        </div>
                                        <div className="text-2xl font-extrabold text-[#111]">₹{grandTotal.toFixed(2)}</div>
                                    </div>

                                    {/* Paid With Section */}
                                    <div className="pt-4 border-t border-gray-50 mt-4">
                                        <h3 className="text-gray-900 font-bold text-[15px] mb-4">Paid With</h3>
                                        <div className="bg-white border border-gray-100 rounded-2xl md:rounded-3xl p-3 md:p-4 flex items-center gap-3 md:gap-4 shadow-sm">
                                            <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center p-2 shadow-sm border border-gray-50">
                                                <Image src="/gpay.png" alt="Google Pay" width={32} height={32} />
                                            </div>
                                            <div>
                                                <h4 className="text-gray-900 font-bold text-sm">Google Pay</h4>
                                                <p className="text-[#EE9C24] font-bold text-[10px]">Got Discount 10%</p>
                                            </div>
                                        </div>
                                    </div>
                                </>
                ...
                <div className="px-4 pt-6 space-y-6">
                    ...
                    <div className="bg-white rounded-[2rem] p-6 shadow-sm border border-gray-50">
                        <div className="flex items-center gap-2 mb-6">
                            <h3 className="text-sm font-black text-gray-800 uppercase tracking-widest">Address</h3>
                            <CircleHelp className="text-gray-400" size={16} />
                        </div>
                        <div className="flex items-start gap-4">
                            <div className="w-10 h-10 bg-gray-50 rounded-xl flex items-center justify-center flex-shrink-0">
                                <MapPin className="text-gray-400" size={20} />
                            </div>
                            <p className="text-xs font-bold text-gray-800 leading-relaxed pt-1">
                    ...
                    <div>
                        <h2 className="text-sm font-black text-gray-800 mb-6 px-2">Review Order</h2>
                        <div className="space-y-4 mb-4">
                            {cartItems && cartItems.length > 0 ? (
                                cartItems.map((item: any) => (
                                    <div key={item._id} className="bg-white rounded-[2rem] p-4 flex gap-4 shadow-sm border border-gray-50">
                                        ...
                                        <div className="flex-1 min-w-0 flex flex-col justify-between">
                                            <div>
                                                <h4 className="text-[10px] font-black text-gray-800 leading-tight mb-1 truncate">
                                                    {item.comboId?.name || item.productId?.name || item.variantId?.productId?.name || "Product Name"}
                                                </h4>
                                                <div className="flex items-center gap-2">
                    ...
                    <div className="bg-white rounded-[2rem] p-6 shadow-sm border border-gray-50 mb-10">
                        ...
                        <div className="space-y-4 mb-6">
                            ...
                            <div className="flex justify-between items-center pt-4 border-t border-gray-50">
                                <span className="text-gray-800 font-black text-xs uppercase tracking-tight">Grand Total</span>
                                    ...
                                    <div key={idx} onClick={() => setSelectedAddress(idx)} className="flex items-start gap-4 cursor-pointer">
                                        ...
                                        <div className="flex flex-col">
                                            ...
                                            <p className="text-xs font-bold text-gray-800 leading-relaxed pr-4">
                                                {addr?.street || contactData?.street || 'No Address selected'}
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <div className="space-y-4">
                            ...
                            >
                                ...
                                <div className="text-right">
                                    ...
                                    <p className="text-sm font-black text-[#111]">₹250</p>
                                </div>
                            </div>
                            ...
                            >
                                ...
                                <div className="text-right">
                                    <p className="text-[8px] font-bold text-gray-400 uppercase mb-0.5">Fee</p>
                                    <p className="text-sm font-black text-[#111]">₹150</p>
                                </div>
                            </div>
                        </div>
